...
TfLiteStatus InitializeMicroFeatures(tflite::ErrorReporter* error_reporter) {
  ...
  if (model->version() != TFLITE_SCHEMA_VERSION) {
    TF_LITE_REPORT_ERROR(error_reporter, "Model provided for Feature generator is schema version %d "
...
TfLiteStatus GenerateSingleFeature(tflite::ErrorReporter* error_reporter,
...
TfLiteStatus GenerateFeatures(tflite::ErrorReporter* error_reporter,
  ...
  while (remaining_samples >= kAudioSampleDurationCount &&
    ...
    TF_LITE_ENSURE_STATUS(
        GenerateSingleFeature(error_reporter, audio_data, kAudioSampleDurationCount,
